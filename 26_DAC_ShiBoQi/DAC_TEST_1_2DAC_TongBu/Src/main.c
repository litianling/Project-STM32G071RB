...
{
  /* 配置NVIC 以使能DMA中断 */
	NVIC_SetPriority(DMA1_Channel1_IRQn,1); /* DMA IRQ优先级低于DAC IRQ */
  NVIC_EnableIRQ(DMA1_Channel1_IRQn);
  NVIC_SetPriority(DMA1_Channel2_3_IRQn,2); /* DMA IRQ优先级低于DAC IRQ */
  ...
  LL_DMA_ConfigAddresses(DMA1,LL_DMA_CHANNEL_1,(uint32_t)&WaveformSine_12bits_32samples,LL_DAC_DMA_GetRegAddr(DAC1, LL_DAC_CHANNEL_1,
	...
	LL_DMA_ConfigAddresses(DMA1,LL_DMA_CHANNEL_2,(uint32_t)&WaveformSine_12bits_32samples,LL_DAC_DMA_GetRegAddr(DAC1, LL_DAC_CHANNEL_2,
												LL_DAC_DMA_REG_DATA_12BITS_RIGHT_ALIGNED),LL_DMA_DIRECTION_MEMORY_TO_PERIPH);
